<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"/www/wwwroot/tmp.eyutong.cn/public/../application/admin/view/index/index.html";i:1573659325;s:67:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/meta.html";i:1573659325;s:69:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/header.html";i:1573660453;s:67:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/menu.html";i:1573659325;s:70:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/control.html";i:1573659325;s:69:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/script.html";i:1573659325;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini">Gelee</span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b>Gelee</span>
</a>
                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-xs-4 text-center">
                                    <a href="https://www.gelee.xyz" target="_blank"><?php echo __('Gelee'); ?></a>
                                </div>
                            </div>
                        </li>
                        <!-- Menu Footer-->
...
<section class="sidebar">
    ...
    <ul class="sidebar-menu <?php if($config['fastadmin']['multiplenav']): ?>show-submenu<?php endif; ?>">
        ...
        <li data-rel="external"><a href="https://doc.gelee.xyz" target="_blank"><i class="fa fa-list text-red"></i> <span><?php echo __('Docs'); ?></span></a></li>
        <li data-rel="external"><a href="https://forum.gelee.xyz" target="_blank"><i class="fa fa-comment text-yellow"></i> <span><?php echo __('Forum'); ?></span></a></li>
        <li data-rel="external"><a href="https://jq.qq.com/?_wv=1027&k=487PNBb" target="_blank"><i class="fa fa-qq text-aqua"></i> <span><?php echo __('QQ qun'); ?></span></a></li>-->
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2017-2018 <a href="https://www.gelee.xyz">Gelee</a>.</strong> All rights reserved.
            </footer>
