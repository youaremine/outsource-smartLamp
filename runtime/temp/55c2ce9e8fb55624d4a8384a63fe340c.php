<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/www/wwwroot/tmp.eyutong.cn/public/../application/admin/view/dashboard/index.html";i:1573659325;s:70:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/layout/default.html";i:1573659325;s:67:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/meta.html";i:1573659325;s:69:"/www/wwwroot/tmp.eyutong.cn/application/admin/view/common/script.html";i:1573659325;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <ul class="products-list product-list-in-box">
                                    <?php $__FOR_START_1349509548__=1;$__FOR_END_1349509548__=8;for($i=$__FOR_START_1349509548__;$i < $__FOR_END_1349509548__;$i+=1){ ?>
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/assets/img/avatar.png" style="height:40px;width:40px;">
                                        </div>
                                        <div class="product-info">
                                            <a href="https://www.gelee.xyz" target="_blank" class="product-title">
                                                Gelee
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="https://www.gelee.xyz" target="_blank">一款基于ThinkPHP5+Bootstrap的极速后台开发框架<span class="pull-right text-red"><i class="fa fa-angle-down"></i> 12%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">一键生成CRUD控制器模型和视图 <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">一键压缩打包JS和CSS文件 <span class="pull-right text-red"><i class="fa fa-angle-down"></i> 3%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">一键生成控制器菜单和规则 <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 8%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">一键生成API接口文档 <span class="pull-right text-yellow"><i class="fa fa-angle-left"></i> 0%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">强大的插件扩展功能，在线安装卸载升级插件 <span class="pull-right text-red"><i class="fa fa-angle-down"></i> 10%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">通用的会员模块和API模块 <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 2%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">共用同一账号体系的Web端会员中心权限验证和API接口会员权限验证 <span class="pull-right text-red"><i class="fa fa-angle-down"></i> 6%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">二级域名部署支持，同时域名支持绑定到插件 <span class="pull-right text-yellow"><i class="fa fa-angle-left"></i> 0%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">多语言支持，服务端及客户端支持 <span class="pull-right text-yellow"><i class="fa fa-angle-left"></i> 0%</span></a></li>
                                    <li><a href="https://www.gelee.xyz" target="_blank">基于Bootstrap开发，自适应手机、平板、PC <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
